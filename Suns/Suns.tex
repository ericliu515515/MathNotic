...
\begin{align*}
M \mapsto  \Hom (N,M)\quad \text{ and }\quad F(f)(g)\triangleq f \circ g
\end{align*}
and an additive \emph{contravariant} functor $\Hom  (-,N):\mathcal{A}\rightarrow \mathbf{Ab}$ defined by 
\begin{align*}
M \mapsto \Hom  (M,N)\quad \text{ and }\quad G(f)(g)\triangleq g \circ f
\end{align*}
...
\begin{equiv_def}
\textbf{(Injective and projective objects)}
\end{equiv_def}
