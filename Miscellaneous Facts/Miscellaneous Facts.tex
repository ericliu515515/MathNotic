...
\end{align*}
Note that $\gamma''=0$ and $\gamma (0)=(a,b)$. Now by \myref{Lemma}{5102} and \myref{Lemma}{5103}, we have 
\begin{align*}
...
Compute using \myref{Lemma}{5103}
\begin{align*}
...
\end{align*}
where $\sigma (\tau_S)$ is the Borel $\sigma$-algebra of $S$. This is true when $S$ is open or closed in  $X$ (\myref{Theorem}{SBs}), but not true in general.  
\end{mdframed}
\begin{theorem}
\label{SBs}
