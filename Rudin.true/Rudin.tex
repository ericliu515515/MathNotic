...
\end{corollary}
\fbox{\begin{minipage}{39em}
Now comes the inequalities about rational power concerning only positive base. Notice there is no definition of a negative raised to the power of a rational.
\end{minipage}}
\begin{theorem}
