...
\end{proof}
\begin{question}{}{}
Solve the hear equation with convection: 
\begin{align*}
...
\end{proof}
\begin{question}{}{}
Show that $S_x(x,y,t)\triangleq S(x,t)S(y,t)$ satisfy the diffusion equation $S_t=k(S_{xx}+S_{yy})$. \\
...
&=- \int_{-\infty}^{\infty}S(-x-y,t)\phi_{\operatorname{odd}}(-y)dy \\
&=-\int_{-\infty}^{\infty}S(x+y,t)\phi_{\operatorname{odd}}(-y)dy \\
&=\int_{\infty}^{-\infty}S(x-z)\phi_{\operatorname{odd}}(z)dz=-u(x,t)\hspace{0.5cm}(\because z=-y)
\end{align*}
...
\end{align*}
Now, we have proved that $u$ is even in $x$. This then give $u_x(0,t)=0$, and solve the \textbf{Neumann problem} by letting $w\triangleq u|_{(\R^+)^2}$
\end{mdframed}
\begin{question}{}{}
Solve 
\begin{align*}
...
\begin{enumerate}[label=(\alph*)]
  ...
  \item Deduce that $u$ satisfy the Robin condition. 
\end{enumerate}
\end{question}
\begin{proof}
